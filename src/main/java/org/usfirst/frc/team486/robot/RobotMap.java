...
public class RobotMap {
	...
	public static int front_stinger1 = 11;
	public static int front_stinger2 = 10;
	public static int push1 = 9;
	public static int push2 = 8;
	//Driverstick buttons
	public static int vault_button = 2;
	//Station buttons
	...
	public static int vault_solenoid = 2;
	public static int front_stinger = 4;
