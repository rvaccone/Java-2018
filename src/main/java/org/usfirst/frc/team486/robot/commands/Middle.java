	...
	public Middle() {
    	...
    	if(gameData.length()>0) {
    		...
    		if(gameData.charAt(0) == 'L') {
        		...
        		addSequential(new GyroTurn(-30,0.6));
        		addSequential(new AutoDriveDistance(60, 0.55));
        	}
        	else {
        		addParallel(new GrabTimer(4));
        		addParallel(new AutoLiftSwitch(525));
        		addSequential(new GyroTurn(-16,0.65));
        		addSequential(new AutoDriveDistance(125, 0.65));
        	}
    	}
    }
}
